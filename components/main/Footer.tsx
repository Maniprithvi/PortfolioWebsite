...
const Footer = () => {
  return (
  <div className="w-full h-full bg-transparent text-gray-200 shadow-lgp-[15px] mt-60 p-10 " style={{borderTop:"2px solid white"}}>
    <div className="flex w-full flex-col items-center justify-center m-auto">
        <div className="w-full h-full flex flex-row items-center justify-around flex-wrap text-center">
        ...
        <div className="text-[15px] mb-[20px] text-center mt-10">
