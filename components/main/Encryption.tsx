    ...
    <div className="flex flex-row relative gap-5 items-center justify-center min-h-screen w-full h-full" id="about-me">
      <div className="absolute  w-auto h-auto top-0 z-[5] mb-10">
        <motion.div
          ...
          className=" mb-10 text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500"
        >
      ...
      <div className="w-[90%] mx-auto mt-10 flex flex-row mx-auto">
          <div className="w-[50%] relative hidden md:block">
            <Image src="/images/profil.jpg" objectFit="contain" layout="fill" alt=""/>
          </div>
          <div className=" w-[50%] ">
            ...
            <div className="flex flex-row gap-20">
              ...
              <div className=" m-8">
                <ul style={{borderLeft:'solid white 2px '}}>
                  ...
                  <li className="p-4"> <strong className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">Degree:</strong>Bsc</li>
                  <li className="p-4"> <strong className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">Email:</strong> 007maniprithvi@gmail.com</li>
